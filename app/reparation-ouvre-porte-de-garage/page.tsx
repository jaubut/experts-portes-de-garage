...
export const metadata: Metadata = {
  ...
  description:
    "Installation et réparation d'ouvre-porte de garage en Estrie et Montérégie. Belt Drive, Chain Drive, Screw Drive, Jackshaft. Techniciens certifiés. Appelez le 450-558-5788.",
  openGraph: {
