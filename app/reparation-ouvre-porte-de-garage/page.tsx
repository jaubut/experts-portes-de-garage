...
export const metadata: Metadata = {
  ...
  description:
    "Installation et réparation d'ouvre-porte de garage en Estrie et Montérégie. Belt Drive, Chain Drive, Screw Drive, Jackshaft. Techniciens certifiés. Appelez le 438-808-9604.",
  openGraph: {
    title: "Ouvre-porte de Garage — Installation & Réparation",
    description:
      "Installez ou réparez votre ouvre-porte de garage avec nos techniciens certifiés. Devis gratuit, service rapide en Estrie et Montérégie.",
