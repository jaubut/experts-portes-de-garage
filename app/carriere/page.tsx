    ...
    <>
      ...
      <section className="bg-[#1a1a1a] py-20 md:py-28">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h1 className="font-heading text-4xl md:text-5xl text-white uppercase leading-tight mb-5">
      ...
      <section className="bg-white py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <p className="text-brand font-bold text-sm uppercase tracking-widest mb-2 text-center">Ce qu&apos;on offre</p>
          <h2 className="font-heading text-2xl md:text-3xl text-[#1a1a1a] uppercase text-center mb-12 leading-tight">
            Un travail valorisant
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {avantages.map((a) => (
              <div key={a.title} className="bg-gray-50 border border-gray-100 rounded-2xl p-6 flex flex-col gap-4">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row items-center gap-10">
            <div className="flex-1 text-center md:text-left">
              <p className="text-white/70 font-bold text-sm uppercase tracking-widest mb-3">Poste disponible</p>
              <h2 className="font-heading text-2xl md:text-3xl text-white uppercase leading-tight mb-4">
            ...
            <div className="grid grid-cols-2 gap-3 shrink-0">
              {perks.map((p) => (
                <div key={p.label} className="bg-white/15 border border-white/25 rounded-xl px-4 py-3 flex items-center gap-3">
      ...
      <section className="bg-[#f5f5f5] py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <p className="text-brand font-bold text-sm uppercase tracking-widest mb-2 text-center">Formation & croissance</p>
          ...
          <div className="space-y-5 text-gray-600 text-base leading-relaxed">
            <p>Chez nous, on croit qu&apos;un bon technicien, ça se forme. C&apos;est pourquoi on offre une <strong className="text-[#1a1a1a]">formation pratique complète</strong>, directement sur le terrain, pour t&apos;apprendre tout ce qu&apos;il faut — de l&apos;entretien à l&apos;installation, en passant par la relation client et l&apos;utilisation de nos outils technologiques.</p>
            <p>Mais on ne t&apos;enseigne pas juste quoi faire : on t&apos;explique <strong className="text-[#1a1a1a]">pourquoi on le fait</strong>. Tu apprendras à comprendre le fonctionnement complet d&apos;une porte de garage — ressorts, câbles, rails, ouvre-portes et systèmes de sécurité — pour pouvoir diagnostiquer et résoudre chaque problème avec précision.</p>
            <p>Tu seras accompagné par des techniciens d&apos;expérience qui te guideront pas à pas, jusqu&apos;à ce que tu sois capable d&apos;intervenir seul, avec confiance et professionnalisme.</p>
            <p>On mise sur un <strong className="text-[#1a1a1a]">apprentissage concret, humain et progressif</strong>, adapté à ton rythme et à ton niveau.</p>
            <p>Chez nous, on ne cherche pas juste des employés : on forme des experts. Des gens curieux, travaillants et fiers de bien faire les choses. Et si tu veux avancer, on t&apos;ouvre la voie — vers des postes de <strong className="text-[#1a1a1a]">chef d&apos;équipe, de formateur ou même de gestion de projets</strong>.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#1a1a1a] py-14">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <p className="text-brand font-bold text-sm uppercase tracking-widest mb-2 text-center">Profil recherché</p>
          ...
          <div className="flex flex-col gap-4">
            {traits.map((t) => (
              <div key={t} className="flex items-start gap-4 bg-white/5 border border-white/10 rounded-xl px-5 py-4">
      ...
      <section className="bg-white py-16">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="font-heading text-2xl md:text-3xl text-[#1a1a1a] uppercase mb-3 leading-tight">
            Prêt à rejoindre nos équipes?
          </h2>
          <p className="text-gray-500 mb-8">Nos techniciens se déplacent rapidement partout en Estrie et Montérégie.</p>
          <a
            href="tel:4505585788"
            className="inline-flex items-center gap-3 bg-brand text-white font-heading text-lg md:text-xl px-8 py-4 rounded-xl hover:bg-brand-dark transition-colors shadow-lg shadow-brand/20 uppercase tracking-wide mb-4"
          >
