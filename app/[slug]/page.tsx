...
export default async function SlugPage(props: PageProps<"/[slug]">) {
  ...
  return (
    <>
      ...
      {/* ── CONTENT ── extra top padding on desktop for tech image bleed ── */}
      <div className="bg-white pt-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-14">
          ...
          {/* Bottom CTA */}
          <div className="mt-14 bg-muted rounded-2xl p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
